...
CREATE TABLE customers_dbt_tests(
	id SERIAL PRIMARY KEY,
	name VARCHAR(255),
	email VARCHAR(255)
);

INSERT INTO customers_dbt_tests (name, email) VALUES
('Alice', 'alice@example.com'),
('Bob', NULL),
(NULL, 'charlie@example.com'), 
('Charlie', 'alice@example.com');

CREATE TABLE orders_dbt_tests(
...
INSERT INTO orders_dbt_tests (order_date, customer_id, status, amount, country_code) VALUES
...
('2024-01-01', 10, 'placed', 100.00, 'US');

CREATE TABLE order_items_dbt_tests (
...
INSERT INTO order_items_dbt_tests (order_id, product_id, quantity, price) VALUES
(1, 101, 1, 100.00),
(5, 102, 2, 100.00),
(3, 103, 3, 100.00),
(4, 101, 1, 150.00);